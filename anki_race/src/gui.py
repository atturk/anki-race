...
VICTORY_DONATION_PHRASES = [
    ...
    "Make a generosity pit-stop: support this addon!"
]

VICTORY_RATING_PHRASES = [
    "Keep this addon in pole position, {link}! It's free!",
    "Put this addon in turbo mode, {link} It's free!",
    "Award 5 stars on the starting grid, {link}! It's free!",
    "Overtake all bugs and {link}! It's free!",
    "Help this addon reach the top of the podium, {link}! It's free!"
]
